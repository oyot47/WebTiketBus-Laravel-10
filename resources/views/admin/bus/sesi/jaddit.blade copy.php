            ...
            <div class="card card-primary">
             ...
             <!-- form start -->
               <div class="card-body">
                ...
                <!-- Isi nilai default untuk kota tujuan dan terminal asal dan tujuan -->
                <!-- Anda dapat melakukan hal serupa untuk input lainnya -->
                ...
                <div class="form-group">
                    ...
                    <select name="terminal_asal_id" class="form-control" id="terminal_asal_id" value="{{ $jadwal->terminal_asal_id }}">
                ...
                <div class="form-group">
                    ...
                    <select name="terminal_tujuan_id" class="form-control" id="terminal_tujuan_id" value="{{ $jadwal->terminal_tujuan_id }}">
                ...
                <!-- Anda dapat melakukan hal serupa untuk input tanggal sampai, jam keberangkatan, jam sampai, destinasi waktu, dan jumlah tiket tersedia -->
