...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-12">
          <a href=" {{ route('admin.halcreate') }} " class="btn btn-primary mb-3">Tambah Data</a>
          <div class="card">
                ...
                <tbody>
                  @foreach ($users as $u)
                    ...
                    <tr>
                      ...
                      <td>{{ $u->role }}</td>
                      <td>
                        <a href="{{ route('admin.edit',['id' =>$u->id]) }}" class="btn btn-primary btn-sm"><i class="fas fa-pen"></i> Edit</a>
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <p>Apakah kamu yakin ingin menghapus data <b>{{ $u->name }}</b></p>
                          </div>
                          <div class="modal-footer justify-content-between">
                            <form action="{{ route('admin.delete',['id'=> $u->id]) }}" method="POST">
                              @csrf
                              @method('DELETE')
